 ...
 *                                    new Date("2010-09-13"));
 * @param {int}   start     The start date for the timeline. optional
 * @param {int}   end       The end date for the timeline. optional
...
links.Timeline.prototype.applyRange = function (start, end, zoomAroundDate) {
    ...
    var startValue = start; // number
    var endValue = end;     // number
